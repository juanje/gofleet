...
public class RolAdmin {
	...
	static final Log log = LogFactory.getLog(RolAdmin.class);
	...
	public static boolean delete(Rol f) {
		return rolHome.delete(f);
	}

	public static boolean saveOrUpdate(Rol f) {
		rolHome.removeFlotas(f);
		return rolHome.saveOrUpdate(f);
	}
}

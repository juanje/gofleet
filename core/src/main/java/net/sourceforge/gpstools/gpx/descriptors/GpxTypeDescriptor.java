 ...
 * Schema.
 * $Id: GpxTypeDescriptor.java 358 2008-11-24 19:06:17Z ringler $
 */
...
/**
 * Class GpxTypeDescriptor.
 * 
 * @version $Revision: 358 $ $Date: 2007-07-16 16:55:47 +0200 (Mo, 16 Jul 2007) $
 */
public class GpxTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GpxTypeDescriptor() {
        ...
        desc.setSchemaType("net.sourceforge.gpstools.gpx.GpxExtensions");
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.topografix.com/GPX/1/1");
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        ...
        //-- validation code for: _gpxExtensions
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    ...
    public java.lang.Class getJavaClass(
        ...
        return net.sourceforge.gpstools.gpx.GpxType.class;
    }

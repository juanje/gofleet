 ...
 * Schema.
 * $Id: EmailTypeDescriptor.java 358 2008-11-24 19:06:17Z ringler $
 */
...
import net.sourceforge.gpstools.gpx.EmailType;

/**
 * Class EmailTypeDescriptor.
 * 
 * @version $Revision: 358 $ $Date: 2007-07-16 16:55:47 +0200 (Mo, 16 Jul 2007) $
 */
public class EmailTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EmailTypeDescriptor() {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                EmailType target = (EmailType) object;
                return target.getId();
            }
            @Override
    ...
    public java.lang.Class getJavaClass(
        ...
        return net.sourceforge.gpstools.gpx.EmailType.class;
    }

...
public class DistanceOrder extends Order {
	...
	protected DistanceOrder(String propertyName, Geometry geom,
			boolean ascending) {
	...
	public static DistanceOrder asc(String propertyName, Geometry geom) {
		return new DistanceOrder(propertyName, geom, true);
	}

	public static DistanceOrder des(String propertyName, Geometry geom) {
		return new DistanceOrder(propertyName, geom, false);
	}
}